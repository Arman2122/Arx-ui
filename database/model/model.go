// Package model defines the database models and data structures used by the Arx-ui panel.
package model
...
// User represents a user account in the Arx-ui panel.
type User struct {
...
// Setting stores key-value configuration settings for the Arx-ui panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
