// Package web provides the main web server implementation for the Arx-ui panel,
...
import (
	...
	"github.com/Arman2122/Arx-ui/v2/web/controller"
	"github.com/Arman2122/Arx-ui/v2/web/job"
	"github.com/Arman2122/Arx-ui/v2/web/locale"
	"github.com/Arman2122/Arx-ui/v2/web/middleware"
	"github.com/Arman2122/Arx-ui/v2/web/network"
...
// Server represents the main web server for the Arx-ui panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("Arx-ui", store))
