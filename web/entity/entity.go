// Package entity defines data structures and entities used by the web layer of the Arx-ui panel.
package entity
...
// AllSetting contains all configuration settings for the Arx-ui panel including web server, Telegram bot, and subscription settings.
